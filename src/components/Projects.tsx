      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8">
          {projects.map((project, index) => (
            <Card
              key={index}
              className="glass hover:shadow-glow transition-all duration-500 hover:-translate-y-1 group animate-scale-in overflow-hidden"
              style={{
            ...
            >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge
                        ...
                        className={`text-xs ${project.status === "Completed" ? "bg-emerald-600" : "bg-amber-600"}`}
                      >
                        {project.status}
                      </Badge>
                    </div>
              ...
              <CardContent className="space-y-4 sm:space-y-6 p-5 sm:p-6 pt-0">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed bg-muted/50 p-3 rounded-lg">
                    {project.myRole}
                  </p>
                </div>
